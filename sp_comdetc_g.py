...
record_path = '/novo/omdb/pds02/PDS2843/data/sprint_tid_ascvd/gzn/thesis/HBDM/results/sp/sp_g_cad.pkl'
temp_neighbor_path = '/novo/omdb/pds02/PDS2843/data/sprint_tid_ascvd/gzn/thesis/HBDM/results/sp/sp_g_cad.csv'
...
if __name__ == "__main__":
    ...
    for result in results:
        ...
        dists.extend(dist)
    print(starts,neighbors,dists)
    print(len(starts),len(neighbors),len(dists))
