...
class Spectral_clustering_init():
    ...
    def spectral_clustering(self):
        # Convert CUDA tensors to CPU tensors and numpy
        ...
        nodes1all=np.concatenate((nodes1,ndoes2))
        nodes2all=np.concatenate((ndoes2,nodes1))

   
        Affinity_matrix=sparse.coo_matrix((weightes,(nodes1all,nodes2all)),shape=(self.input_size,self.input_size))
