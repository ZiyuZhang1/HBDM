        ...
        for latent_dim in latent_dims:
            ...
            if args.W == 1 or args.W == 0:
                ...
                for epoch in tqdm(range(args.epochs),desc="HBDM is Running…",ascii=False, ncols=75):
                    ...
                    loss_curve.append([epoch,(loss.item()*N)/elements])
                    if epoch%1000==0:
                        ...
                        cad_pr_var_record.append(pr_var_ks)
                        cad_roc_var_record.append(roc_var_ks)
                        # print(cadroc,cadpr)
            ...
            with open(record_path, 'wb') as file:
                ...
                pickle.dump([epoch_recod,cad_roc_record,cad_pr_record,pr_var_ks], file)
            # Close the file
            file.close()
