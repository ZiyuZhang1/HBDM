...
#SBATCH -J sct3_process
#SBATCH -o sct3_process.log
#SBATCH -e sct3_process.err
...
# graph_df = pd.read_csv('/novo/omdb/pds02/PDS2843/data/sprint_tid_ascvd/gzn/thesis/data/s_all.csv')
